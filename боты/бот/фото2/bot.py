...
def welcome(message):
 ...
 item3 = types.KeyboardButton("закадки")
...
def test(message):
    ...
    if message.chat.type == 'private':
        if message.text == '🎲 Рандомное число':
            ...
            bot.send_message(message.chat.id, 'я бот созданый криворуким програмистом, сейчас умею отправлять стикер, гифку, фото\nТак же могу тебя послать')
        ...
        elif message.text in ["Иди на хуй", "Иди нахуй","иди на хуй", "иди нахуй","пошел на хуй","пошёл на хуй","пошел нахуй", "пошёл нахуй", "Пошел на хуй", "Пошёл нахуй", "Пошёл на хуй"]:
